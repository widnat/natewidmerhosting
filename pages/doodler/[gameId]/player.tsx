...
import LargeImage from "@/components/doodler/LargeImage";
import LargeText from "@/components/doodler/LargeText";
  ...
  return (
    <>
      ...
      {connected && component === PlayerComponent.WaitingForOtherPlayers && (
        <div className="flex items-center justify-center h-screen bg-gradient-to-l from-cyan-200 to-blue-200">
          <LargeText text="Sit back and relax while the others guess!" />
        </div>
      )}
